var BCLSDDrenditions = (function(window, document) {
      var BCLSrenditionData = {
        ...
        progressiveAudioFields = ['audio_bitrate', 'audio_channels', 'audio_codec', 'forced_aac_profile', 'skip_video'],
        ...
        hevcFields = ['video_bitrate', 'height', 'aspect_mode', 'decoder_bitrate_cap', 'decoder_buffer_size', 'keyframe_rate', 'fragment_duration', 'speed', 'video_codec'],
